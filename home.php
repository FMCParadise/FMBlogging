                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="categories/chevelu.php">Chevelu</a></li>
                                <li><a class="dropdown-item" href="categories/non-chevelu.php">Non-Chevelu</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="categories/trans-chevelu.php">Trans-Chevelu</a></li>
